// Sélecteur de langue pour CityLoop Quest Lille
...
class LanguageSelector {
    ...
    createSelector(container = null) {
        // NE PAS CR�0ER LE S�0LECTEUR SUR LA PAGE PARCOURS
        if (window.location.pathname.includes('parcours.html')) {
            return null;
        }
        
        // SUPPRESSION RADICALE DE TOUS LES S�0LECTEURS EXISTANTS
...
// Synchroniser le sélecteur à chaque changement de langue (TEMPORAIREMENT D�0SACTIV�0)
if (window.translationManager) {
    ...
    window.translationManager.setLanguage = function(lang) {
        ...
        // TEMPORAIREMENT D�0SACTIV�0 pour éviter la boucle infinie
