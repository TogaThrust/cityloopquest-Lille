/**
 * Réécrit les descriptions POI Lille en textes visiteurs, sans formulation interne.
 * Usage: node scripts/rewrite-lille-poi-descriptions.mjs
 */
import fs from "fs";
